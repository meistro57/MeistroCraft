...
class PullRequestManager:
    ...
    def _generate_pr_description(
        ...
        description = """## MeistroCraft Automated Changes
...
"""
        ...
        if task:
            comment += """### 🎯 MeistroCraft Task Context
- **Action**: {task.get('action', 'unknown')}
- **File**: {task.get('filename', 'N/A')}
...
class IssueManager:
    ...
    def _generate_issue_description(
        ...
        description = """## 🐛 MeistroCraft Task Failure
...
def create_workflow_integration(github_client: GitHubClient,
                                config: Dict[str, Any] = None) -> Optional[WorkflowIntegration]:
    """
