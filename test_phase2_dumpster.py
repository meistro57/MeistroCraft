...
def run_dumpster_integration_test():
    ...
    dumpster_tasks = [
        ...
        ("books/guide.pdf", "Documentation file"),
    ...
    print(f"   Repository: meistro57/Dumpster")
    print(f"   Features: PR creation, Issue tracking, Workflow analysis")
    print(f"   Commands: --github prs/issues/workflow meistro57/Dumpster")
